...
public void user_fill_affiliate_form_with_below_information_company_website_tax_id_payment_method(DataTable dataTable) {
...
retail.enterEditAccountValues(editAccountInfo.get(0).get("firstname"),
		editAccountInfo.get(0).get("lastName"), editAccountInfo.get(0).get("email"),
		editAccountInfo.get(0).get("telephone"));
